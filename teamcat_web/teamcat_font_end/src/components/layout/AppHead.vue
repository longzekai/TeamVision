  ...
  <div id="app-head" class="app-head master-page-header-font">
    <Row>
      <i-col :lg="1" :md="2" :sm="2" :xs="2" class="app-head-logo app-head-item">
        <a href="/project"><img src="../../assets/teamcat/global/less/logo.png" class="img-circle"
                             style="width: 40px; height: 40px;"></a>
      </i-col>
      <i-col :lg="1" :md="1" :sm="0" :xs="0" class="app-head-title">
        TeamCat
      </i-col>
      <i-col id="headermenu" :lg="15" :md="10" :sm="15" :xs="15" class="app-head-menu app-head-item">
      ...
      <i-col id="headersettings" :lg="5" :md="8" :sm="7" :xs="7" class="pull-right app-head-settings app-head-item">
        <!--<ul class="list-inline">-->
