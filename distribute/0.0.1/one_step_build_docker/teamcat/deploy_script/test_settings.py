...
ROOT_DIR = "/web/www/test_teamcat/doraemon"
...
BASE_DIR_TEST = "/web/www/test_teamcat/doraemon"
EMAIL_TEMPLATES = {
...
LOG_CONFIG = ('/web/www/test_teamcat/doraemon/logconfig.conf').replace('\\', '/')

WEB_HOST = "http://teamcat.cn:8043"
REST_FRAMEWORK = {
